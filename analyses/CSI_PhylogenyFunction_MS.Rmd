...
ggsave("../figures/BrayCurtis_Ordination.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=NA, height=NA, dpi=900, limitsize=TRUE)
```
...
# PhyloFactorization
PF <- PhyloFactor(OTUtable, tree, trt, stop.fcn = "KS", stop.early = T)
class(PF)
...
trt2 <- trt
PF <- PhyloFactor(OTUtable, tree, trt, nfactors=10)
class(PF)
