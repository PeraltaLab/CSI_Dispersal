...
# Root tree
tree.45.mid <- midpoint.root(tree.45)
...
sal.trt <- list("0_PSU" = c(0), "5_PSU" = c(5), "9_PSU" = c(9), 
                "13_PSU" = c(13), ">0PSU" = c(5, 9, 13))
...
mtext("Avg Cluster Depth", side = 1, line = 3, cex = 1.25)
...
How do the indicators change over time - assembly!!!!! 
---------
