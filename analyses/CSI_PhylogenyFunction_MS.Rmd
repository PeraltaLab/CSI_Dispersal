...
# PERMANOVA UniFrac
str(unifrac.dist)
adonis <- adonis(unifrac.dist~Salinity*Dispersal*Date, data = design_final, perm=1000, set.seed=42)
adonis
...
# PERMANOVA OTU
adonis <- adonis(sampleREL.dist~Salinity*Dispersal*Date, data = design.ns.final, perm=1000, set.seed=42)
adonis
```
