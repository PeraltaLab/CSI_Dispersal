...
# PLOT GGPLOT WITH SOURCE TANKS (where is salinity 0???)
```{r}
...
#HOW DO I CREATE A REL ABUN MATRIX FROM THIS TO USE IN EUCLIDEAN DISTANCE?

```

NOTHING BELOW THIS POINT WORKS OR IS CORRECT.
...
sampleREL.dist3 <- vegdist(csi_relabun.ns, method="bray")

#euclidean distance for leaf litter decomp
euc.decomp <- vegdist(decomp, method = "euclidean")

#matrix comparison
mantel.ns <- mantel(sampleREL.dist3, euc.decomp)
```
