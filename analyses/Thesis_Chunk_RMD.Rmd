...
fresh <-  occupants(csi_pres_abs[which(design_final$Number == 3), ])

draw.pairwise.venn(area1 = length(salt), area2 = length(fresh),
...
overlap <- calculate.overlap(list(salt, sal0, sal5, sal9, sal13))

draw.quintuple.venn(c(rev(lengths(overlap))), direct.area = T, scaled = T)


draw.quintuple.venn(area1 = length(salt), area2 = length(sal0),
     ...
     n14 = length(Reduce(intersect, list(salt, sal9))),
     n15 = length(Reduce(intersect, list(salt, sal13))),
     ...
     n124 = length(Reduce(intersect, list(salt, sal0, sal9))),
     n125 = length(Reduce(intersect, list(salt, sal0, sal13))), 
     n134 = length(Reduce(intersect, list(salt, sal5, sal9))),
     n135 = length(Reduce(intersect, list(salt, sal5, sal13))),
     n145 = length(Reduce(intersect, list(salt, sal9, sal13))),
     ...
     n1234 = length(Reduce(intersect, list(salt, sal0, sal5, sal9))),
     n1235 = length(Reduce(intersect, list(salt, sal0, sal5, sal13))),
     n1245 = length(Reduce(intersect, list(salt, sal0, sal9, sal13))),
     n1345 = length(Reduce(intersect, list(salt, sal5, sal9, sal13))),
     n2345 = length(Reduce(intersect, list(sal0, sal5, sal9, sal13))),
     n12345 = length(Reduce(intersect, list(salt, sal0, sal5, sal9, sal13))), 
     scaled = T)
