...
```{r}
#load design file
design2 <- read.csv("E:/Grad/Mothur/mothur/design2_CSI.csv", row.names=1)
design2
...
```{r}
#import tax file
CSIdataa <- read.otu("E:/Grad/Mothur/mothur/CSI.15.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.pick.opti_mcc.unique_list.shared")
...
row.names(CSIdataRELa) == row.names(design3)
head(newCSIdatd)
